...
@endsection
  ...
  @section('content')
        ...
        <form action="creategroup" method="post">
          ...
          <h2 style="color: #000000; text-align: center; padding-bottom: 50px;  margin-top:-650px;" >Create Group....</h2>

          <h2 style="color: #000000; text-align: center; padding-bottom: 50px;  margin-top:-500px;" >Create Group....</h2>
            <div class="alert alert-info" style="width:300px;height: 100px;margin-left: 400px; margin-top: 50px;">
